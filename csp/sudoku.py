    ...
    for value in values:
        if value in D[var]:
            ...
            if check.consistency(sudoku_copy, value, var):                # check consistency for this value
                ...
                if logic:
                    sudoku_copy, D_copy, q, PATH, n_node = backtrack(sudoku_copy, D_copy, X, q, PATH, n_node)     # DON'T ASSIGN TO sudoku, D because return False globally for every problem
